...
from catboost import CatBoostRegressor, Pool  # Import Pool for CatBoost data handling
...
models = {
    "1": {
        ...
        "param_distributions": {
            'regressor__n_estimators': [100, 200] if quick_run else [50, 100, 200, 250, 300],
            'regressor__max_depth': [3, 5] if quick_run else [3, 5, 7, 9],
...
submission.to_csv('submission_improved_stacking_v5.csv', index=False)
