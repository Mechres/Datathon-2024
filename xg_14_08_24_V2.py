...
for model_num in selected_models:
    ...
    if model_name == "XGBoost":
        param_distributions['regressor__learning_rate'] = [0.01, 0.1, 0.2, 0.4]  # Expanded range
    elif model_name == "Gradient Boosting":
        param_distributions['regressor__learning_rate'] = [0.01, 0.1, 0.2, 0.4]
    elif model_name == "SVR":
        param_distributions = {
    ...
    cv = 10  # Increased folds for more robust evaluation
