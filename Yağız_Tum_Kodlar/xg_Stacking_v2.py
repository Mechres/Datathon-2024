...
models = {
    ...
    "4": ("SVR", SVR()),
    "5": ("CatBoost", CatBoostRegressor(random_state=31, verbose=0))  # Add CatBoost
}
...
for model_num in selected_models:
    ...
    if model_name == "XGBoost":
        # TPOT for XGBoost hyperparameter tuning
        ...
        print("Best cross-validation score (RMSE):", np.sqrt(-tpot.score(X_val, y_val)))
...
test = test.drop('Dogum Tarihi', axis=1)
